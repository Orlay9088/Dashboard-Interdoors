...
* [hallazgo 2 con datos concretos]
* [hallazgo 3 con datos concretos]
...
**Recomendacion**
* [1 accion concreta y accionable para gerencia]

- NO uses bloques de codigo ```. Solo texto con * y **. Se breve y directo."""
